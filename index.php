...
<body>
    <div id="container" style="position: fixed; left: 0px; top: 10em; right: 0px; bottom: 2em; overflow: auto;">
    ...
    <span style="color:#000000;font-family:Arial;font-size:27px;">Welcome to use this NBA Management system, you can<br>redirect to different pages according to your role by clicking the buttons bellow.</span></div>
        <div id="Layer1">
            <div id="jQueryButton1" style="position:absolute;left:93px;top:100px;width:276px;height:130px;z-index:0;">
            ...
            <div id="jQueryButton2" style="position:absolute;left:542px;top:100px;width:276px;height:130px;z-index:1;">
